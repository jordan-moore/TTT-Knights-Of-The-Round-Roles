	...
	function SWEP:DrawHUD()
		...
		if hide_role then
			surface.SetDrawColor(255 * bright,
				...
				255 * bright,
				255 * alpha)
		elseif (client.IsTraitor and client:IsTraitor()) or (client.IsAssassin and client:IsAssassin()) or (client.IsHypnotist and client:IsHypnotist()) or (client.IsVampire and client:IsVampire()) or (client.IsWraith and client:IsWraith()) or (client.IsKiller and client:IsKiller()) then
			surface.SetDrawColor(255 * bright,
				50 * bright,
				50 * bright,
				255 * alpha)
