...
function ScoreEventLog(events, scores, traitors, detectives, hypnotists, mercenaries, jesters, phantoms, glitches, wraiths, vampires, swappers, assassins, killers)
	for k, s in pairs(scores) do
		...
		scores[k].was_wraith = table.HasValue(wraiths, k)
		scores[k].was_vampire = table.HasValue(vampires, k)
