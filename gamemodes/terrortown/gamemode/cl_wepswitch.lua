...
local col_dark = {
	tip = {
		...
		[ROLE_HYPNOTIST] = Color(240, 70, 220, 255),
		[ROLE_GLITCH] = Color(230, 90, 0, 255),
		[ROLE_JESTER] = Color(170, 20, 240, 255),
		[ROLE_PHANTOM] = Color(82, 226, 255, 255),
		[ROLE_WRAITH] = Color(69, 97, 0, 255),
		[ROLE_VAMPIRE] = Color(45, 45, 45, 255),
		[ROLE_SWAPPER] = Color(111, 0, 255, 255),
...
function WSWITCH:DrawBarBg(x, y, w, h, col)
	...
	local c = (hide_role and col.none) or (GetRoundState() == ROUND_ACTIVE and col.tip[role]) or col.none
	
	if c == nil then
		LocalPlayer():PrintMessage(HUD_PRINTCONSOLE, role)
		c = Color(60, 160, 50, 155)
	end
